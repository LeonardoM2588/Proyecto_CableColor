...
{
    class TipoSectorController
    {
        //Propiedades de la clase System
        string query;

        //Controller Listar Generos
        public void ListarTipoSector(string Procedimiento, string indicador, string values)
        {
            try
            {
                ...
                TipoSectorModel.ListarTipoSector = dt;
            }
