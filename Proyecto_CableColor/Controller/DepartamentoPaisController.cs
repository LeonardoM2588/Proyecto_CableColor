...
{
    class DepartamentoPaisController
    {
        //Propiedades de la clase System
        string query;

        //Controller Listar Estado Civil
        public void ListarDepartamentoPaises(string Procedimiento, string indicador, string values)
        {
            try
            {
                ...
                DepartamentoPaisModel.ListarDepartamentosPaises = dt;
            }
