...
{
    class TipoPaquetesController
    {
        //Propiedades de la clase System
        string query;

        //Controller Listar Tipos De Paquetes
        public void ListarPaquetes(string Procedimiento, string indicador, string values)
        {
            try
            {
                ...
                TiposPaquetesModel.ListarTipoPaquetes = dt;
            }
