    ...
    public partial class Frm_Ordenes : Form
    {
        ...
        private void Guardar()
        {
            if (errors == 0)
            {
                ...
                procedimiento = "[sp_Ordenes]";
                indicador = "1";
                values = "'" + OM.Cod_Cliente_Pendiente + "','" + OM.Cod_Cliente + "','" + OM.Fecha_Instalacion + "','" + OM.Cod_Empleado + "','" + OM.Telefono + "','" + OM.UsuarioCreacion + "',NULL";
        ...
        {
            OM = new OrdenesModel();
            OM.Cod_Cliente_Pendiente = int.Parse(Txt_CodOrden.Text);
            OM.Fecha_Instalacion = Dtp_FechaInstalacion.Value;
            OM.Telefono = Txt_Celular.Text;
            OM.FechaCreacion = DateTime.Today;
            OM.UsuarioCreacion = DataUser.USERNAME;
            OM.FechaModificacion = DateTime.Today;
            OM.UsuarioModificacion = DataUser.USERNAME;
            ...
            if (Busqueda.Rows.Count > 0)
            {
                ...
                {
                    OM.Cod_Cliente = int.Parse((DATOS["Cod_Cliente"].ToString()));
                }
            }
            ...
            if (Busqueda.Rows.Count > 0)
            {
                ...
                {
                    OM.Cod_Empleado = int.Parse((DATOS["Cod_Empleado"].ToString()));
                }
            }
        }
        ...
        private void Btn_Imprimir_Click(object sender, EventArgs e)
        {
            ...
            {
                Reportes.Frm_Reporteria Reporte = new Reportes.Frm_Reporteria(6);
                Reporte.Show();
            }
        }
        ...
        private void Nuevo()
        {
            ...
            columns = "Cod_Cliente_Pendiente";
            table = "Orden_Instalacion";
            Busqueda = D.GetNextID(columns, table, "");
            Txt_CodOrden.Text = Busqueda.ToString();
        ...
        public void Registros()
        {
            ...
            if (DataUser.ROLE == "Administrador" || DataUser.ROLE == "Supervisor Residencial")
            {
                ...
                values = "'','','','','',''";
                OC.ListarOrdenes(procedimiento, indicador, values, Usuario);
                dgv_registros.DataSource = OrdenesModel.ListarOrdenes;
                Data();
            }
            else
            {
        ...
        public void Data()
        {
            ...
            if (DataUser.ROLE == "Administrador" || DataUser.ROLE == "Supervisor Residencial")
            {
                ...
                Usuario = DataUser.USERNAME;
                values = "'','','','','',''";
                OC.ListarOrdenes2(procedimiento, indicador, values, Usuario);
                dgv_Data.DataSource = OrdenesModel.Data;
            }
            else
            {
                procedimiento = "[sp_Ordenes]";
        ...
        {
            string CuerpoCorreo = "LISTADO DE ORDENES" + "<br>" + "<br>";
            ...
            CuerpoCorreo = CuerpoCorreo + "<th>Cod_Cliente_Pendiente</th>";
            CuerpoCorreo = CuerpoCorreo + "<th>Nombre_Cliente</th>";
            CuerpoCorreo = CuerpoCorreo + "<th>Fecha_Instalacion</th>";
            ...
            //-------------------------------------------------------------
            email.From = new MailAddress("LeonardoMolinaEnvia@outlook.com", "REPORTE DE ORDENES");
            email.Subject = "LISTADO DE ORDENES ";
        ...
        void ExportarExcel()
        {
            ...
            xlWorkBook.SaveAs("Reporte_Ordenes.xls", Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
        ...
        void ExportarPdf()
        {
            if (dgv_registros.Rows.Count > 0)
            {
                ...
                save.FileName = "Lista_Ordenes.pdf";
        ...
        public new void Update()
        {
            if (H.MsgQuestion("¿Desea Actualizar Este Producto?") == "S")
            {
                ...
                procedimiento = "[sp_Ordenes]";
                indicador = "2";
                values = "'" + OM.Cod_Cliente_Pendiente + "','" + OM.Cod_Cliente + "','" + OM.Fecha_Instalacion + "','" + OM.Cod_Empleado + "','" + OM.Telefono + "','" + OM.UsuarioCreacion + "','" + OM.UsuarioModificacion + "'";
        ...
        private void Busqueda()
        {
            ...
            {
                OrdenesModel.ListarOrdenes.DefaultView.RowFilter = $"Nombre_Cliente like '%{txt_buscar.Text}%'";
            }
            else if (rbn_Empleado.Checked == true)
            {
                OrdenesModel.ListarOrdenes.DefaultView.RowFilter = $"Nombre_Empleado like '%{txt_buscar.Text}%'";
            }
        }
        ...
        {
            Seteo();
            string Procedimiento = "[sp_Ordenes]";
            string indicador = "3";
            string id = "'" + OM.Cod_Cliente_Pendiente + "'";
            string values = "'','','','','',''";
        ...
        private void dgv_registros_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgv_registros.SelectedRows.Count > 0)
            {
                Nuevo();
                Btn_Nuevo.Enabled = false;
                Txt_CodOrden.Text = dgv_registros.CurrentRow.Cells["Cod_Cliente_Pendiente"].Value.ToString();
                Dtp_FechaInstalacion.Text = dgv_registros.CurrentRow.Cells["Fecha_Instalacion"].Value.ToString();
